...
namespace ShoppingApp.Api.Controllers
{
    ...
    public class CartController : ControllerBase
    {
        ...
        {
            var unvalidatedProducts = products.Select(MapInputGradeToUnvalidatedGrade)
                                              .ToList()
                                              .AsReadOnly();
        ...
        private static UnvalidatedProduct MapInputGradeToUnvalidatedGrade(InputCart product) => new UnvalidatedProduct(
