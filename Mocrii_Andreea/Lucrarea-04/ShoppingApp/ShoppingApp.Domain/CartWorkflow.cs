...
namespace ShoppingApp.Domain
{
    public class CartWorkflow
    {
        ...
        {
            UnvalidatedCart unvalidatedProducts = new UnvalidatedCart(command.InputProduse);
            ...
            return await result.Match(
                   Left: examGrades => GenerateFailedEvent(examGrades) as IPaidCartEvent,
                   Right: publishedGrades => new SuccessPaidCartEvent(publishedGrades.Csv, publishedGrades.PublishedDate)
               );
        }
